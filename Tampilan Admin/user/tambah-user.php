    ...
    <div class="card-body">
      <form action="">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="namaUser" placeholder="Masukan Username" name="userName" />
        </div>
        <div class="mb-3">
          <label for="email" class="form-label">Email</label>
          <input type="email" class="form-control" id="namaKategori" placeholder="Masukan Email" name="email" />
        </div>
        <div class="mb-3">
